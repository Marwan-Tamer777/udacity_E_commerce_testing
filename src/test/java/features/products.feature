...
Feature: user product actions and searching actions
  ...
  Scenario: SC4- Logged User "test14@example.com" "password" could search for any product
  ...
  Scenario: SC5- Logged User "test14@example.com" "password" could switch between currencies US-Euro
    Given logged User "test14@example.com" "password" navigates to home page
...
#    When user selects currency 1
  ...
  Scenario: SC6- Logged user "test14@example.com" "password" could select different Categories
    Given logged User "test14@example.com" "password" navigates to home page
 ...
 #   When user clicks on category "Computers"
  ...
  Scenario: SC7- Logged user "test14@example.com" "password" could filter with color
    Given logged User "test14@example.com" "password" navigates to shoes page
  ...
  Scenario: SC8- Logged user "test14@example.com" "password" could select different tags
    Given Logged User "test14@example.com" "password" navigates to search page
